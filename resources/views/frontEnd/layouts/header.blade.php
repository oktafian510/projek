                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="#"><i class="fa fa-phone"> </i>082334739813</a></li>
                            <li><a href="#"><i class="fa fa-envelope"></i> Oktafian510@gmail.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-4">
                   ...
                   <h1 style="color:orange;">TMStore</h1>
                ...
                <div class="col-sm-9">
                    ...
                    <div class="mainmenu pull-left">
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            ...
                            <li><a href="https://wa.me/6282334739813" target="_blank">Contact</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-3">
