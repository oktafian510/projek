                ...
                <div class="col-sm-4 col-sm-offset-1">
                    <div class="login-form"><!--login form-->
                        ...
                        <div class="form-group {{$errors->has('billing_state')?'has-error':''}}">
                            <input type="text" class="form-control" name="billing_state" value="{{$user_login->state}}" id="billing_state" placeholder=" Billing Province">
                ...
                <div class="col-sm-4">
                    <div class="signup-form"><!--sign up form-->
                        ...
                        <div class="form-group {{$errors->has('shipping_state')?'has-error':''}}">
                            <input type="text" class="form-control" name="shipping_state" value="" id="shipping_state" placeholder="Shipping Province">
